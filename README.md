...
If you do not define a `template` or its corresponding `action` the climate device will not have that attribute, e.g. define `swing_mode_template`/`set_swing_mode` for vertical swing support or `swing_horizontal_mode_template`/`set_swing_horizontal_mode` for horizontal swing support.
...
| swing_horizontal_mode_template   | [`template`](https://www.home-assistant.io/docs/configuration/templating) | Defines a template to get the horizontal swing mode of the climate device.                                                                                                                                                                                                                      |                                                    |
...
| set_swing_horizontal_mode        | [`action`](https://www.home-assistant.io/docs/scripts)                    | Defines an action to run when the climate device is given the set horizontal swing mode command. Can use `swing_horizontal_mode` variable.                                                                                                                                                      |                                                    |
|                                  |                                                                           |                                                                                                                                                                                                                                                                                                 |                                                    |
...
| swing_horizontal_modes           | `list`                                                                    | A list of supported horizontal swing modes.                                                                                                                                                                                                                                                     | ["on", "off"]                                      |
|                                  |                                                                           |                                                                                                                                                                                                                                                                                                 |                                                    |
...
climate:
  - platform: climate_template
    ...
    # horizontal swing mode switch for UI.
    swing_horizontal_mode_template: "{{ states('input_boolean.bedroom_horizontal_swing_mode') }}"
    ...
    set_hvac_mode:
      ...
      - service: esphome.bedroom_node_aircon_state
        data:
          ...
          swing_horizontal_mode: "{{ is_state_attr('climate.bedroom_aircon', 'swing_horizontal_mode', 'on') }}"
